window.onload = function() {
    ...
    function detectTA(e) {
        if(e.target.id == "edit-page-textarea") {
            ...
            s.innerHTML = '.candyBox {background: rgba(8, 1, 30);font-family: Inter, "Noto Sans SC", "Noto Sans TC", BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Fira Sans', 'Droid Sans', 'Helvetica Neue', Arimo, Verdana, Geneva, sans-serif;font-size: .8em;max-height: 10rem;max-width: 12rem;overflow-y: scroll;position: absolute;text-align: left;width: 99rem;}.candyBox::-webkit-scrollbar {width: 4.25px;}.candyBox::-webkit-scrollbar-track {background: none;}.candyBox::-webkit-scrollbar-thumb {background: rgba(232, 69, 69);}.candyBox a {cursor: pointer;display: block;color: rgba(253, 236, 207);padding: 0.25em 0.5em;transition: all .175s ease-in-out;}.candyBox a span {display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 1;overflow: hidden;white-space: pre;}.candyBox a.selected, .candyBox a:hover {background: rgba(253, 236, 207);color: rgba(8, 1, 30);text-decoration: none;}';
